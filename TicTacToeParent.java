...
class TicTacToeParent {
    ...
    TicTacToeParent(int size, int chips, char dot_x, char dot_o, char dot_empty) {
        this.size = size;
        this.chips = chips;
        this.dot_x = dot_x;
        this.dot_o = dot_o;
...
class TicTacToe extends TicTacToeParent {

    TicTacToe(int size, int chips, char dot_x, char dot_o, char dot_empty) {
        super(size, chips, dot_x, dot_o, dot_empty);
    }
}